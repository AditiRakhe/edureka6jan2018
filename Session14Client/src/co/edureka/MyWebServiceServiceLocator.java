...
public class MyWebServiceServiceLocator extends org.apache.axis.client.Service implements co.edureka.MyWebServiceService {
    ...
    private java.lang.String MyWebService_address = "http://localhost:8080/Session14/services/MyWebService";
    ...
    public co.edureka.MyWebService getMyWebService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            co.edureka.MyWebServiceSoapBindingStub _stub = new co.edureka.MyWebServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (co.edureka.MyWebService.class.isAssignableFrom(serviceEndpointInterface)) {
                co.edureka.MyWebServiceSoapBindingStub _stub = new co.edureka.MyWebServiceSoapBindingStub(new java.net.URL(MyWebService_address), this);
                _stub.setPortName(getMyWebServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://edureka.co", "MyWebServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://edureka.co", "MyWebService"));
        }
